...
export function Card({ cardStyle = 'default', children, style }: CardProps) {
  ...
  return (
    <div style={{ borderRadius: 'var(--radius-xl)', padding: 'var(--space-6)', fontFamily: 'var(--font-base)', ...styleMap[cardStyle], ...style }}>
      {children}
    </div>
  );
}
